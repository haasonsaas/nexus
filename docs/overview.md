...
5. **Secure by Default** - Tool execution in sandboxed runners (Docker by default; optional Firecracker or Daytona), encrypted credentials
...
6. **Tool Executor** - Executes tool calls in a sandbox (Docker by default; optional Firecracker or Daytona)
...
- **Sandbox backends** - Docker (default), optional Firecracker microVMs, or Daytona remote sandboxes for stronger isolation
