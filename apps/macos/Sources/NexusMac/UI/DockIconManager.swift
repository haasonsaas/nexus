...
final class DockIconManager: NSObject, @unchecked Sendable {
    ...
    private let logger = Logger(subsystem: "com.nexus.mac", category: "DockIconManager")
    ...
    func updateDockVisibility() {
        Task { @MainActor in
            ...
            let userWantsDockHidden = !UserDefaults.standard.bool(forKey: Self.showDockIconKey)
