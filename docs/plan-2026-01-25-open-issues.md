...
- Implementation: in progress (#96 RAG evaluation phase 1; provider routing + Ollama provider + discovery started; #82 knowledge packs CLI; #95 experiment scaffolding; #91 skill tool scaffolding).
