...
// IsToolRetryable checks if a tool error should be retried.
...
// LoopError represents an error in the agentic loop.
...
// LoopPhase represents a phase in the agentic loop.
