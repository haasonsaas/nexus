...
const (
	ProvisioningService_StartProvisioning_FullMethodName           = "/nexus.v1.ProvisioningService/StartProvisioning"
	ProvisioningService_GetProvisioningStatus_FullMethodName       = "/nexus.v1.ProvisioningService/GetProvisioningStatus"
	ProvisioningService_SubmitProvisioningStep_FullMethodName      = "/nexus.v1.ProvisioningService/SubmitProvisioningStep"
	ProvisioningService_CancelProvisioning_FullMethodName          = "/nexus.v1.ProvisioningService/CancelProvisioning"
	ProvisioningService_GetProvisioningRequirements_FullMethodName = "/nexus.v1.ProvisioningService/GetProvisioningRequirements"
)
...
type ProvisioningServiceClient interface {
	...
	SubmitProvisioningStep(ctx context.Context, in *SubmitProvisioningStepRequest, opts ...grpc.CallOption) (*SubmitProvisioningStepResponse, error)
	// CancelProvisioning cancels an active provisioning session.
	CancelProvisioning(ctx context.Context, in *CancelProvisioningRequest, opts ...grpc.CallOption) (*CancelProvisioningResponse, error)
	// GetProvisioningRequirements returns the provisioning requirements for a channel type.
	GetProvisioningRequirements(ctx context.Context, in *GetProvisioningRequirementsRequest, opts ...grpc.CallOption) (*GetProvisioningRequirementsResponse, error)
}
...
func (c *provisioningServiceClient) StartProvisioning(ctx context.Context, in *StartProvisioningRequest, opts ...grpc.CallOption) (*StartProvisioningResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProvisioningService_StartProvisioning_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *provisioningServiceClient) SubmitProvisioningStep(ctx context.Context, in *SubmitProvisioningStepRequest, opts ...grpc.CallOption) (*SubmitProvisioningStepResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SubmitProvisioningStepResponse)
	err := c.cc.Invoke(ctx, ProvisioningService_SubmitProvisioningStep_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *provisioningServiceClient) CancelProvisioning(ctx context.Context, in *CancelProvisioningRequest, opts ...grpc.CallOption) (*CancelProvisioningResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CancelProvisioningResponse)
	err := c.cc.Invoke(ctx, ProvisioningService_CancelProvisioning_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *provisioningServiceClient) GetProvisioningRequirements(ctx context.Context, in *GetProvisioningRequirementsRequest, opts ...grpc.CallOption) (*GetProvisioningRequirementsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetProvisioningRequirementsResponse)
	err := c.cc.Invoke(ctx, ProvisioningService_GetProvisioningRequirements_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProvisioningServiceServer interface {
	...
	// SubmitProvisioningStep submits data for a provisioning step.
	SubmitProvisioningStep(context.Context, *SubmitProvisioningStepRequest) (*SubmitProvisioningStepResponse, error)
	// CancelProvisioning cancels an active provisioning session.
	CancelProvisioning(context.Context, *CancelProvisioningRequest) (*CancelProvisioningResponse, error)
	// GetProvisioningRequirements returns the provisioning requirements for a channel type.
	GetProvisioningRequirements(context.Context, *GetProvisioningRequirementsRequest) (*GetProvisioningRequirementsResponse, error)
...
func (UnimplementedProvisioningServiceServer) StartProvisioning(context.Context, *StartProvisioningRequest) (*StartProvisioningResponse, error) {
...
func (UnimplementedProvisioningServiceServer) SubmitProvisioningStep(context.Context, *SubmitProvisioningStepRequest) (*SubmitProvisioningStepResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SubmitProvisioningStep not implemented")
}
func (UnimplementedProvisioningServiceServer) CancelProvisioning(context.Context, *CancelProvisioningRequest) (*CancelProvisioningResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CancelProvisioning not implemented")
}
func (UnimplementedProvisioningServiceServer) GetProvisioningRequirements(context.Context, *GetProvisioningRequirementsRequest) (*GetProvisioningRequirementsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProvisioningRequirements not implemented")
}
...
func _ProvisioningService_StartProvisioning_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProvisioningService_StartProvisioning_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProvisioningService_SubmitProvisioningStep_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SubmitProvisioningStepRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProvisioningServiceServer).SubmitProvisioningStep(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProvisioningService_SubmitProvisioningStep_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProvisioningServiceServer).SubmitProvisioningStep(ctx, req.(*SubmitProvisioningStepRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ProvisioningService_CancelProvisioning_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CancelProvisioningRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProvisioningServiceServer).CancelProvisioning(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProvisioningService_CancelProvisioning_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProvisioningServiceServer).CancelProvisioning(ctx, req.(*CancelProvisioningRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ProvisioningService_GetProvisioningRequirements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetProvisioningRequirementsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProvisioningServiceServer).GetProvisioningRequirements(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProvisioningService_GetProvisioningRequirements_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProvisioningServiceServer).GetProvisioningRequirements(ctx, req.(*GetProvisioningRequirementsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProvisioningService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nexus.v1.ProvisioningService",
	HandlerType: (*ProvisioningServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "StartProvisioning",
			Handler:    _ProvisioningService_StartProvisioning_Handler,
		},
		{
		...
		{
			MethodName: "SubmitProvisioningStep",
			Handler:    _ProvisioningService_SubmitProvisioningStep_Handler,
		},
		{
			MethodName: "CancelProvisioning",
			Handler:    _ProvisioningService_CancelProvisioning_Handler,
		},
		{
			MethodName: "GetProvisioningRequirements",
			Handler:    _ProvisioningService_GetProvisioningRequirements_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "pkg/proto/nexus.proto",
